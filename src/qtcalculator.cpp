      ...
      : QDbfDialog(title, parent)
{
    ...
    editareGroupBox->setTitle(QApplication::translate("Dialog", "Supports elementary operations and brackets", 0));
    optionsGroupBox->setTitle(QApplication::translate("Dialog", "Options", 0));

    formulaLabel->setText(QApplication::translate("Dialog", "&Formula", 0));
    resultLabel->setText(QApplication::translate("Dialog", "&Result", 0));
    decimalLabel->setText(QApplication::translate("Dialog", "&Decimal places", 0));
